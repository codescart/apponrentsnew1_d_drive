...
class mostrated_banner extends StatefulWidget {
  const mostrated_banner({Key? key}) : super(key: key);

  @override
  State<mostrated_banner> createState() => _mostrated_bannerState();
}

class _mostrated_bannerState extends State<mostrated_banner> {
