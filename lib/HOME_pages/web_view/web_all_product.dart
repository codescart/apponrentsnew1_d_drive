...
class web_all_categories extends StatefulWidget {
  String? id;
  ...
  @override
  State<web_all_categories> createState() => _web_all_categoriesState();
}
List<String> favoriteDataList = [];

class _web_all_categoriesState extends State<web_all_categories> {
